class Solution:
    ...
    def ladderLength(self, beginWord: str, endWord: str, wordList: List[str]) -> int:
        ...
        while q:
            ...
            # have to loop through all words currently in the queue since we have to check all the possible
            # words we could branch off of in each layer, not just one word at a time. this is a level-by-level
            # BFS approach, so it is basically just a "true" BFS approach.
