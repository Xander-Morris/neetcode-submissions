"""
    The order is only preserved for the binary search due to the constraints
    of the problem itself, not because I sort anything, or due to any intrinsic
    sorting properties that Python enforces. 
"""
...
class TimeMap:
    ...
    def get(self, key: str, timestamp: int) -> str:
        ...
        if timestamp in self.store[key]["direct"]:
